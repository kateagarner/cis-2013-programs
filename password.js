...
{
        stringOutput = ("The password is not long enough");
 }
else
{
    for(var i = 0; i < arrayBadPasswords.length; i++)
    {
        ...
        {
                stringOutput = ("The password matches a commonly used bad password; please choose a different password.");
         }
    }
}
if (stringOutput === "")
{
    stringOutput = ("Nice job! Great password:)");
}
