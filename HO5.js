...
floatMidPts = parseFloat(prompt("Please enter Midterm exam pts:"));

floatFinPts = parseFloat(prompt("Please enter Final Exam pts:"));
...
alert("Final Grade: " + stringFinalGrade);
}
